...
export default function Profile() {
  ...
  // fetch all badges to show locked ones too
  useEffect(() => {
  ...
  // ensures badgeID matches, locked badges show right name/icon and earned badges show earned date in tooltip
        ...
        <div className="badge-grid">
          {mergedBadges.map((b, i) => (
            <div
              ...
              key={i}
              onMouseEnter={(e) => {
                // show tooltip on hover with icon and description, otherwise show locked message
                setTooltip({
                  visible: true,
                  x: e.clientX,
                  y: e.clientY,
